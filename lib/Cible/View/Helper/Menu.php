 ...
 * @version    $Id: Menu.php 1856 2016-01-26 11:20:40Z ssoares $
 */
    ...
    protected function generateList($tree, $addFirstLastClasses = false, $level = 1)
    {
        ...
        foreach ($tree as $object)
        {
            if(isset($object)){
                ...
                if(isset($object['MID_Show']) && $object['MID_Show'] == 0){
                ...
                if ((!empty($object['child']) && is_array($object['child']) || $this->_buildOnCatalog)
                    && !$this->_disable_nesting)
                {
