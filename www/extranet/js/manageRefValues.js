...
(function($) {
    ...
    var methods = {
        init: function(options) {
            ...
            return this.each(function() {
                ...
                $(this).bind('click', function() {
                    ...
                    o.params.outputType = methods._setOutputType($(this));;
                    methods.display(o);
                    return false;
                });
        ...
        _setOutputType: function(elem)
        {
            var value = '';
            var outputElem = elem.prev();
            var attrClass = outputElem.attr('class').split(' ');
            $.each(attrClass, function(i, val){
                switch (val){
                    case 'radio':
                    case 'multiselect':
                    case 'multicheckbox':
                    ...
                    o.post.url = o.baseUrl + o.referencesAction + '/actionKey/rebuild';
                        $.getJSON(
                            ...
                            function(data){
                                ...
                                if (o.params.outputType != ''){
                                    list =o.params.currentObj.prev().children('select');
//                                     $('.'+o.params.outputType+' > select');
                                }else{
                                    list = $('select[id$=' + o.params.dropdown+ ']');
                                }
                                ...
                                list.each(function(){
                                    ...
                                    switch (o.params.outputType){
                                        case 'multiselect':
                                            ...
                                            currentList.val(selected).trigger("chosen:updated");
                                            break;
                                        default :
                                            // Récupérer la valeur déjà sélectionnée
