<?php
    ...
    class NewsFormCategory extends Cible_Form_Multilingual
    {
        public function __construct($options = null)
        {
            ...
            $optionLabel = new Zend_Form_Element_Text('CI_GotoList');
            $optionLabel->setLabel($this->_view->getCibleText('form_label_CI_GotoList'));
            $label = $optionLabel->getDecorator('Label');
            $label->setOption('class', $this->_labelCSS);
            $this->addElement($optionLabel);

            $returnToList = new Zend_Form_Element_Text('CI_ReturnToList');
            $returnToList->setLabel($this->_view->getCibleText('form_return_view_all_label'));
            $label = $returnToList->getDecorator('Label');
            $label->setOption('class', $this->_labelCSS);
            $this->addElement($returnToList);

            $optionColor = new Zend_Form_Element_Text('C_OptionColor');
            $optionColor->setLabel($this->_view->getCibleText('form_label_C_OptionColor'));
            $this->addElement($optionColor);
